        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="relative p-6 flex-auto mx-10">
                ...
                <div>
                    ...
                    <input class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs mb-3" id="password" name="password" type="password" placeholder="At least 8 characters" required>
                ...
                <div>
                    ...
                    <input class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs mb-3" id="password_confirmation" name="password_confirmation" type="password_confirmation" placeholder="Same As Password" required>
            ...
            <div class="px-6 pb-6 rounded-b-xl mx-10">
                ...
                <button class="block text-center bg-serv-button text-white text-lg py-3 px-12 my-2 rounded-lg w-full" onclick="toggleModal('registerSuccessModal');toggleModal('registerModal')">
                    Sign up
                </button>
